  ...
  const initialModalMessage = isSeatLimitExceeded
    ...
    : showRenewalMessage
      ? NEXT_PUBLIC_CLOUD_ENABLED
        ? "Your access to Insight has been temporarily suspended due to a lapse in your subscription."
        : "Your access to Insight has been temporarily suspended due to a lapse in your license."
      : "An Enterprise license is required to use Insight. Your data is protected and will be available once a license is activated.";
      ...
      {isSeatLimitExceeded ? (
        ...
        <>
          <Text text03>
            ...
            Insight&apos;s powerful features, please update your payment
            information.
          </Text>
        ...
        <>
          <Text text03>
            {hadPreviousLicense
              ? "To reinstate your access and continue using Insight, please contact your system administrator to renew your license."
